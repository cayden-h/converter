...
<p align="center">
  A local file converter for macOS and Windows
</p>
...
How releases are built, reviewed and signed is documented in the [Code Signing Policy](docs/code-signing-policy.md).
