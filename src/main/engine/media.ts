...
const BY_MEDIUM: Record<Exclude<Medium, "Other">, readonly string[]> = {
  ...
  Video: [
    ...
    "h266.mkv",
    "mxf", "dnxhd", "dnxhr", "y4m", "prores", "gxf", "amv", "nut", "ivf",
    "dv", "wtv",
  ],
  Audio: [
    "mp3", "wav", "flac", "aac", "ogg", "oga", "opus", "m4a", "wma", "aiff",
    "aif", "alac", "amr", "ac3", "dts", "ape", "wv", "spx", "mka",
    "aifc", "caf", "au", "voc", "w64", "mp2", "tta", "mlp", "m4b", "ra",
    "eac3", "ec3", "mpc", "gsm",
  ],
  Documents: [
...
const NOT_OFFERABLE = new Set([
  ...
  "aai", "adx", "afc", "al", "apm", "aptx", "aptxhd", "art",
  "ast", "aud", "avs", "avs2", "avs3", "bit", "brf", "c2",
  "cal", "cals", "cavs", "chk", "cin", "cip", "clip", "cpk", "cvg",
  "dfpwm", "drc", "dvd", "dxt1", "dxt5",
  "epdf", "epi", "evc", "f4v", "farbfeld", "fax", "ff",
  "ffmeta", "fl32", "flm", "fts", "ftxt", "g3", "g4", "g722",
  "group4", "hrz", "icb", "im1", "im24", "im8", "ipl",
  "ircam", "isma", "ismv", "isobrl", "isobrl6", "j2c", "jls", "jps",
  "js", "jss", "latm", "lbc", "ljpg", "loas", "lrc", "m1v", "m2a", "m2t",
  "m3u8", "mat", "mjpeg", "mjpg", "mmf", "mng", "mpa",
  "mpd", "msbc", "msl", "mtv", "oma", "otb", "pam",
  "pcl", "pcm", "pct", "pfm", "pgmyuv", "pgx", "phm", "picon", "pix",
  "pocketmod", "psp", "ptif", "ras", "rco", "rcv", "rgf",
  "roq", "rs", "rso", "rsvg", "sb", "sbc", "sf", "shtml", "six", "sixel",
  "sox", "spdif", "sun", "sunras", "sup", "sw", "tco", "thd", "tun",
  "ub", "ubrl", "ubrl6", "uil", "ul", "uw", "vag", "vbn", "vda", "vicar",
  "viff", "vips", "vst", "vvc", "wpg", "xface", "xv",
  "xwd", "y",
]);
